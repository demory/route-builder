...
require.register("./client/utils", function (exports, module) {

module.exports.decodePolyline = function (polyline) {
...
require.register("./client/binaryheap", function (exports, module) {
/*
=================================
...
var BinaryHeap = module.exports = function(scoreFunction, idFunction, valueProp) {
    this.content = [];
...
require.register("./client/graph", function (exports, module) {
var haversine = require('trevorgerhardt~haversine@master')
var BinaryHeap = require('./client/binaryheap')
...
require.register("./client/application", function (exports, module) {
var $ = jQuery = require('components~jquery@1.11.1')
